...
<script type="text/javascript">(function() {var params = {rssmikle_url: "http://www.difesapopolo.it/rss/feed/chiesa", 
            rssmikle_frame_width: "30%", 
            ...
            scrollstep: "8",
            mcspeed: "50", 
            sort: "Off", rssmikle_title: "on", 
            rssmikle_title_sentence: "", 
            rssmikle_title_link: "News Difesa del popolo", 
